...
public class MenuItem
{
    ...
    {
         Console.WriteLine($"Item {Id} - {MenuItemName} - ${Price:0.00}.  {MenuItemDesc} {VegetarianStatement.CheckVegetarianStatus(IsVegetarian)}{AllergyStatement.CreateAllergyStatement(ContainsDairy)}{ItemAvailability.CheckItemAvailability(IsAvailable)}");
    }
